...
google.charts.setOnLoadCallback(loadFullPieC);

function loadFullPieC() {
  // Inicializar el mapa
  drawPieC();
...
function columnaAñoC(selectedYear) {
  letter = "B";
  switch (selectedYear) {
    case 0:
      letter = "B";
...
function drawPieC() {
  ...
  queryPieC.send(handleQueryResponsePieC); // Envía el query
}
